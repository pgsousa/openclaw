...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.mcp.allowServers": "MCP Allowed Servers",
  "tools.mcp.allowTools": "MCP Allowed Tools",
  "agents.list[].tools.mcp.allowServers": "Agent MCP Allowed Servers",
  "agents.list[].tools.mcp.allowTools": "Agent MCP Allowed Tools",
